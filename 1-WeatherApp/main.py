...
def get_weather():
    try:
        ...
        api_key = "e4840358d119bdc5d9b4ef770d85dd81"
        ...
        condition_label.config(text=f"{condition} | FEEL LIKE { temp}°")
...
serch_icon =tk.PhotoImage(file="search_icon.png")
serch_icon_Button = tk.Button(root, image=serch_icon, border=0, cursor="hand2", bg="#404040", command=get_weather)
serch_icon_Button.place(x=590, y=34)
#logo
